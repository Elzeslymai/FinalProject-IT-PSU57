...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-right top-nav">
            <li><a href="/FinalProject/checkout.php" data-placement="bottom" data-toggle="tooltip" href="#" data-original-title="Stats"><i class="glyphicon glyphicon-shopping-cart"> Shopping Cart</i>
                </a>
            </li>  
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Hotel User <b class="fa fa-angle-down"></b></a>
                <ul class="dropdown-menu">
                    <li><a href="profile.php" class="edit-toggle"><i class="fa fa-fw fa-user"></i> Edit Profile</a></li>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
				...
				<li ><a href="/FinalProject/shop.php">Shopping<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-shopping-cart"></span></a></li>

				<!--<li ><a href="order-list.php">Shopping Cart<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-list-alt"></span></a></li>-->
               ...
               <li class=""><a href="order-history.php">Order History<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-time"></span></a></li>
                ...
                <li>
                    ...
                    <ul id="submenu-2" class="collapse">
                        <li><a href="profile.php" class="edit-toggle">Edit Profile</a></li>
