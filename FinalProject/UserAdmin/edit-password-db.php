	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p><i class="glyphicon glyphicon-ok-sign"></i>Can't Change Password!!</p>
				
			</div>
			<div class="modal-footer">
				<a href="/FinalProject/UserAdmin/edit-password.php"><button type="button" class="btn btn-default" >Back</button></a>
			</div>
		</div> <!-- /.modal-content -->
	</div> <!-- /.modal-dialog -->
</div> <!-- /.modal -->
...
<div class="modal fade forget-modal" tabindex="-1" role="dialog" aria-labelledby="myForgetModalLabel" aria-hidden="true" id="forgetmodal3">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p><i class="glyphicon glyphicon-ok-sign"></i>Your Old Password was Wrong!!</p>
