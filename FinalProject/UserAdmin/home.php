...
<body >
 	...
 	<br>
    	...
    	<div class="col-md-4">
    	    <a class="info-tiles tiles-inverse has-footer" href="add-user.php">
    		    <div class="tiles-heading">
			        <div class="pull-middle">Add User</div>
        ...
        <div class="col-md-4">
        	<a class="info-tiles tiles-green has-footer" href="user-list.php">
			    <div class="tiles-heading">
        ...
        <div class="col-md-4">
        	<a class="info-tiles tiles-blue has-footer" href="order-list.php">
			    <div class="tiles-heading">
